...
@Properties(
    ...
    value = {
        // GPL only
        @Platform(cinclude = "<libpostproc/postprocess.h>", link = "postproc@.55", extension = { "-gpl", "-gplhwaccel" }),
        @Platform(value = "windows", preload = "postproc-55", extension = { "-gpl", "-gplhwaccel" })
    }
)
